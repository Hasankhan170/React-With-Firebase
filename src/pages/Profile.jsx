...
function Profile() {
  ...
  return (
    ...
    <div style={{margin: '0 auto',borderRadius:'10px', boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 12px",marginTop:'25px'}} className="container p-5 mt-40 max-h-max border-black">
     <form style={{width:"200px",flexDirection:'column',border:'1px solid gray',borderRadius:'10px'}} className="flex text-center justify-center p-3">
     ...
     <div>
      ...
      <button type="submit" style={{width:'100%',textAlign:'start'}} className="btn btn-warning px-2 mt-2">Click</button>
     </form>
